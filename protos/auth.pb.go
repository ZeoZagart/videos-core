...
var file_protos_auth_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x7e, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3b, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x13, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x53,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x14, 0x5a, 0x12, 0x2e, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x73, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70,
...
var file_protos_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.CreateAccount:input_type -> auth.SignUpRequest
	1, // 1: auth.AuthService.Login:input_type -> auth.LoginRequest
	2, // 2: auth.AuthService.CreateAccount:output_type -> auth.LoginResponse
...
type AuthServiceClient interface {
	CreateAccount(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*LoginResponse, error)
...
func (c *authServiceClient) CreateAccount(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
...
type AuthServiceServer interface {
	CreateAccount(context.Context, *SignUpRequest) (*LoginResponse, error)
...
func (*UnimplementedAuthServiceServer) CreateAccount(context.Context, *SignUpRequest) (*LoginResponse, error) {
...
func _AuthService_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CreateAccount(ctx, req.(*SignUpRequest))
	}
